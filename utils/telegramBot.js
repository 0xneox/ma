...
Step into the future of decentralized computing with Neurolov, where your idle processing power becomes a valuable asset.
      ...
      bot.onText(/\/start/, async (msg) => {
        ...
        try {
          ...
          if (!user.hasSeenWelcomeMessage) {
            await bot.sendPhoto(chatId, 'https://i.ibb.co/PYWbpxz/photo-2024-10-11-16-18-3.jpg');
          ...
          await bot.sendMessage(chatId, 'Start computing with Neurolov! 💻💡', {
            reply_markup: {
              inline_keyboard: [
                [{ text: 'Earn', web_app: { url: webAppUrl } }]
              ]
            }
          });
        } catch (error) {
